...
/// <summary>
/// Configuration options for <see cref="HmacHandler"/>.
/// </summary>
public class HmacOptions : AuthenticationSchemeOptions
{
    ...
    /// <summary>
    /// <see cref="IReplayRequestValidator"/> interface. The default implementation is <see cref="Alastack.HmacAuth.AspNetCore.ReplayRequestValidator"/>.
    /// If the value is <c>null</c>, the replay request verification will be disabled.
    /// </summary>
    public IReplayRequestValidator ReplayRequestValidator { get; set; } = default!;
    ...
    /// <summary>
    /// <see cref="IAuthorizationParameterExtractor"/> interface. The default implementation is <see cref="HmacParameterExtractor"/>.
    /// </summary>
    ...
    /// </summary>
    public ICredentialProvider<HmacCredential> CredentialProvider { get; set; } = default!;

    /// <summary>
    /// <see cref="ICredentialCache{TCredential}"/> interface.
    /// </summary>
    public ICredentialCache<HmacCredential> CredentialCache { get; set; } = default!;
    ...
    {
        get => (HmacEvents)base.Events!;
        set => base.Events = value;
    }

    /// <summary>
    /// Initializes a new instance of <see cref="HmacOptions"/>.
    /// </summary>
    public HmacOptions()
    {
        Events = new HmacEvents();
    }
